...
This tutorial is based on [this lovely tutorial](https://labs.ala.org.au/posts/2023-08-28_alternatives-to-box-plots/post.html) by Dax Kellie and Shandiya Balasubramaniam from the ALA team.
...
```{r, eval=FALSE}
austraits <- read_rds("data/austraits.rds")
```
...
leaf_mass <- austraits %>%
  ...
  pluck("traits") # Grab the traits table from the list of austraits tables
```
